...
import { ProjectObjModule } from "../model/project-obj/project-obj.module";
...
export class ProjectsDataService {
  projects: ProjectObjModule[] = [
    ...
    },
    {
      title: "Text To Json",
      description:
        "You can add text to the list and delete them if needed <br> Then you can save them as a json is downloaded with the given name<br> You have to give it a name else you won't be able to download the file",
      component: TextToJsonComponent,
    },
    {
      title: "Multi Line To Json",
      description:
        "You can save to json and download it with the given name all the text in multiple lines <br> I used this to create the Experience objects that are in the resume page <br> and loaded the json files that i created with this tool to build the Ui and fill the data.",
